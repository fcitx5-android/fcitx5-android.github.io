...
[fcitx5-android#175](https://github.com/fcitx5-android/fcitx5-android/pull/175) добавлена поддержка импорта метода ввода на основе таблицы, поэтому после `0.0.3-43` вы можете импортировать таблицу, выполнив следующие действия:
