...
- [如何移除输入法](#如何移除输入法)
- [如何调整输入法顺序](#如何调整输入法顺序)
- [如何修改已经输入但未提交的文本](#如何修改已经输入但未提交的文本)
- [如何重置输入状态](#如何重置输入状态)
- [如何导出配置文件/用户词库](#如何导出配置文件用户词库)
- [如何为拼音输入法导入第三方词库](#如何为拼音输入法导入第三方词库)
- [拼音词库的格式是什么](#拼音词库的格式是什么)
- [如何输入颜文字、emoji 符号与特定的 unicode 符号](#如何输入颜文字emoji-符号与特定的-unicode-符号)
- [如何修复键盘与导航栏重叠的问题](#如何修复键盘与导航栏重叠的问题)
- [“全局选项”中的“默认状态为激活”是什么](#全局选项中的默认状态为激活是什么)
- [“全局选项”中的“共享输入状态”是什么](#全局选项中的共享输入状态是什么)
- [如何自定义 OpenCC 转换配置](#如何自定义-opencc-转换配置)
- [如何使用语音输入](#如何使用语音输入)
  - [Sayboard](#sayboard)
  - [Google 语音输入](#google-语音输入)
